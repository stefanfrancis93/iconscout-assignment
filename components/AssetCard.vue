<template>
  <article
    :title="item.name"
    class="block rounded-xl bg-[#FAFAFC] relative h-[13.125rem] w-full"
  >
    <a
      href="#"
      tabindex="-1"
      class="flex items-center justify-center h-full w-full p-2 group"
    >
          ...
          <img
            ...
            :srcset="
              item.urls.thumb
                ...
                : ''
            "
            class="w-full h-full max-w-full max-h-full object-contain transition-transform duration-300 ease-in-out pointer-events-none group-hover:scale-105"
          />
        </picture>
      </template>
    </a>
